...
{
    internal class JsonSerializer : Utf8Serializer, ISerializer, IDeserializer
    {
        ...
        public dynamic DeserializeDynamic(HttpResponseMessage response)
        {
            throw new NotImplementedException();
        }

        public object DeserializeJson(string content, Type type)
        {
