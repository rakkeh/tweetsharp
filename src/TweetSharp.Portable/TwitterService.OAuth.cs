...
namespace TweetSharp
{
    public partial class TwitterService
    {
        ...
        private readonly Func<FunctionArguments, HttpRequestMessage> _requestTokenQuery
            = args =>
            {
        ...
        private readonly Func<FunctionArguments, HttpRequestMessage> _accessTokenQuery
            = args =>
            {
                var request = new HttpRequestMessage
                {
        ...
        private readonly Func<FunctionArguments, HttpRequestMessage> _protectedResourceQuery
            = args =>
            {
                var request = new HttpRequestMessage
                {
        ...
        private readonly Func<FunctionArguments, HttpRequestMessage> _xAuthQuery
            = args =>
            {
                var request = new HttpRequestMessage
                {
        ...
        public virtual HttpRequestMessage PrepareEchoRequest(string realm = "http://api.twitter.com")
        {
            var args = new FunctionArguments
            {
                ConsumerKey = _consumerKey,
            ...
            var echo = new HttpRequestMessage();
