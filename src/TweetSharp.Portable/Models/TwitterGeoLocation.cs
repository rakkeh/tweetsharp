                                      ...
                                      ITwitterModel
    {
        ...
        public class GeoCoordinates
        {
            ...
            private static GeoCoordinates FromEnumerable(IEnumerable<double> values)
            {
                ...
                IEnumerable<double> coordinates = values as double[] ?? values.ToArray();
                var latitude = coordinates.First();
                var longitude = coordinates.Skip(1).Take(1).Single();
        ...
        public static TwitterGeoLocation None { get; private set; }

        static TwitterGeoLocation()
        {
            None = new TwitterGeoLocation();
        }
