...
#region Implementation
	...
	{	
		...
		public virtual TwitterStatus DeleteTweet(DeleteTweetOptions options)
		{
			...
			return WithHammock<TwitterStatus>(HttpMethod.Delete, "statuses/destroy/{id}", FormatAsString, "?id=", id, "&trim_user=", trim_user);
		}
		...
		public virtual TwitterStatus SendTweet(SendTweetOptions options)
		{
			...
			return WithHammock<TwitterStatus>(HttpMethod.Post, "statuses/update", FormatAsString, "?status=", status, "&in_reply_to_status_id=", in_reply_to_status_id, "&lat=", lat, "&long=", @long, "&place_id=", place_id, "&display_coordinates=", display_coordinates, "&trim_user=", trim_user);
		}
		...
		public virtual TwitterStatus Retweet(RetweetOptions options)
		{
			...
			return WithHammock<TwitterStatus>(HttpMethod.Post, "statuses/retweet/{id}", FormatAsString, "?id=", id, "&trim_user=", trim_user);
		}
		...
		public virtual TwitterStatus SendTweetWithMedia(SendTweetWithMediaOptions options)
		{
			...
			return WithHammock<TwitterStatus>(HttpMethod.Post, "statuses/update_with_media", images, FormatAsString, "?status=", status, "&possibly_sensitive=", possibly_sensitive, "&in_reply_to_status_id=", in_reply_to_status_id, "&lat=", lat, "&long=", @long, "&place_id=", place_id, "&display_coordinates=", display_coordinates);
		}
		...
		public virtual TwitterDirectMessage DeleteDirectMessage(DeleteDirectMessageOptions options)
		{
			...
			return WithHammock<TwitterDirectMessage>(HttpMethod.Post, "direct_messages/destroy", FormatAsString, "?id=", id, "&include_entities=", include_entities);
		}
		...
		public virtual TwitterDirectMessage SendDirectMessage(SendDirectMessageOptions options)
		{
			...
			return WithHammock<TwitterDirectMessage>(HttpMethod.Post, "direct_messages/new", FormatAsString, "?text=", text, "&user_id=", user_id, "&screen_name=", screen_name);
		}
		...
		public virtual TwitterUser FollowUser(FollowUserOptions options)
		{
			...
			return WithHammock<TwitterUser>(HttpMethod.Post, "friendships/create", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&follow=", follow);
		}
		...
		public virtual TwitterUser UnfollowUser(UnfollowUserOptions options)
		{
			...
			return WithHammock<TwitterUser>(HttpMethod.Post, "friendships/destroy", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id);
		}
		...
		public virtual TwitterFriendship UpdateFriendship(UpdateFriendshipOptions options)
		{
			...
			return WithHammock<TwitterFriendship>(HttpMethod.Post, "friendships/update", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&device=", device, "&retweets=", retweets);
		}
		...
		public virtual TwitterAccount UpdateAccountSettings(UpdateAccountSettingsOptions options)
		{
			...
			return WithHammock<TwitterAccount>(HttpMethod.Post, "account/settings", FormatAsString, "?trend_location_woeid=", trend_location_woeid, "&sleep_time_enabled=", sleep_time_enabled, "&start_sleep_time=", start_sleep_time, "&end_sleep_time=", end_sleep_time, "&time_zone=", time_zone, "&lang=", lang);
		}
		...
		public virtual TwitterUser UpdateProfile(UpdateProfileOptions options)
		{
			...
			return WithHammock<TwitterUser>(HttpMethod.Post, "account/update_profile", FormatAsString, "?name=", name, "&url=", url, "&location=", location, "&description=", description, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual TwitterUser UpdateProfileBackgroundImage(UpdateProfileBackgroundImageOptions options)
		{
			...
			return WithHammock<TwitterUser>(HttpMethod.Post, "account/update_profile_background_image", FormatAsString, "?image_path=", imagePath, "&tile=", tile, "&include_entities=", include_entities, "&skip_status=", skip_status, "&use=", use);
		}
		...
		public virtual TwitterUser UpdateProfileImage(UpdateProfileImageOptions options)
		{
			...
			return WithHammock<TwitterUser>(HttpMethod.Post, "account/update_profile_image", FormatAsString, "?image_path=", image_path, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual TwitterUser BlockUser(BlockUserOptions options)
		{
			...
			return WithHammock<TwitterUser>(HttpMethod.Post, "blocks/create", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual TwitterUser UnblockUser(UnblockUserOptions options)
		{
			...
			return WithHammock<TwitterUser>(HttpMethod.Post, "blocks/destroy", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual TwitterStatus UnfavoriteTweet(UnfavoriteTweetOptions options)
		{
			...
			return WithHammock<TwitterStatus>(HttpMethod.Post, "favorites/destroy", FormatAsString, "?id=", id);
		}
		...
		public virtual TwitterStatus FavoriteTweet(FavoriteTweetOptions options)
		{
			...
			return WithHammock<TwitterStatus>(HttpMethod.Post, "favorites/create", FormatAsString, "?id=", id, "&include_entities=", include_entities);
		}
		...
		public virtual TwitterUser RemoveListMember(RemoveListMemberOptions options)
		{
			...
			return WithHammock<TwitterUser>(HttpMethod.Post, "lists/members/destroy", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&user_id=", user_id, "&screen_name=", screen_name, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual TwitterUser FollowList(FollowListOptions options)
		{
			...
			return WithHammock<TwitterUser>(HttpMethod.Post, "lists/subscribers/create", FormatAsString, "?owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&list_id=", list_id, "&slug=", slug);
		}
		...
		public virtual TwitterUser UnfollowList(UnfollowListOptions options)
		{
			...
			return WithHammock<TwitterUser>(HttpMethod.Post, "lists/subscribers/destroy", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual TwitterUser AddListMember(AddListMemberOptions options)
		{
			...
			return WithHammock<TwitterUser>(HttpMethod.Post, "lists/members/create", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&user_id=", user_id, "&screen_name=", screen_name, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual TwitterList DeleteList(DeleteListOptions options)
		{
			...
			return WithHammock<TwitterList>(HttpMethod.Post, "lists/destroy", FormatAsString, "?owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&list_id=", list_id, "&slug=", slug);
		}
		...
		public virtual TwitterList CreateList(CreateListOptions options)
		{
			...
			return WithHammock<TwitterList>(HttpMethod.Post, "lists/create", FormatAsString, "?list_owner=", list_owner, "&name=", name, "&mode=", mode, "&description=", description);
		}
		...
		public virtual TwitterSavedSearch CreateSavedSearch(CreateSavedSearchOptions options)
		{
			...
			return WithHammock<TwitterSavedSearch>(HttpMethod.Post, "saved_searches/create", FormatAsString, "?query=", query);
		}
		...
		public virtual TwitterSavedSearch DeleteSavedSearch(DeleteSavedSearchOptions options)
		{
			...
			return WithHammock<TwitterSavedSearch>(HttpMethod.Post, "saved_searches/destroy/{id}", FormatAsString, "?id=", id);
		}
		...
		public virtual TwitterUser ReportSpam(ReportSpamOptions options)
		{
			...
			return WithHammock<TwitterUser>(HttpMethod.Post, "users/report_spam", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id);
		}
		...
		public virtual IAsyncResult DeleteTweet(DeleteTweetOptions options, Action<TwitterStatus, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Delete, action, "statuses/destroy/{id}", FormatAsString, "?id=", id, "&trim_user=", trim_user);
		}
		...
		public virtual IAsyncResult SendTweet(SendTweetOptions options, Action<TwitterStatus, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "statuses/update", FormatAsString, "?status=", status, "&in_reply_to_status_id=", in_reply_to_status_id, "&lat=", lat, "&long=", @long, "&place_id=", place_id, "&display_coordinates=", display_coordinates, "&trim_user=", trim_user);
		}
		...
		public virtual IAsyncResult Retweet(RetweetOptions options, Action<TwitterStatus, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "statuses/retweet/{id}", FormatAsString, "?id=", id, "&trim_user=", trim_user);
		}
		...
		public virtual IAsyncResult SendTweetWithMedia(SendTweetWithMediaOptions options, Action<TwitterStatus, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "statuses/update_with_media", images, FormatAsString, "?status=", status, "&possibly_sensitive=", possibly_sensitive, "&in_reply_to_status_id=", in_reply_to_status_id, "&lat=", lat, "&long=", @long, "&place_id=", place_id, "&display_coordinates=", display_coordinates);
		}
		...
		public virtual IAsyncResult DeleteDirectMessage(DeleteDirectMessageOptions options, Action<TwitterDirectMessage, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "direct_messages/destroy", FormatAsString, "?id=", id, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult SendDirectMessage(SendDirectMessageOptions options, Action<TwitterDirectMessage, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "direct_messages/new", FormatAsString, "?text=", text, "&user_id=", user_id, "&screen_name=", screen_name);
		}
		...
		public virtual IAsyncResult FollowUser(FollowUserOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "friendships/create", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&follow=", follow);
		}
		...
		public virtual IAsyncResult UnfollowUser(UnfollowUserOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "friendships/destroy", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id);
		}
		...
		public virtual IAsyncResult UpdateFriendship(UpdateFriendshipOptions options, Action<TwitterFriendship, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "friendships/update", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&device=", device, "&retweets=", retweets);
		}
		...
		public virtual IAsyncResult UpdateAccountSettings(UpdateAccountSettingsOptions options, Action<TwitterAccount, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "account/settings", FormatAsString, "?trend_location_woeid=", trend_location_woeid, "&sleep_time_enabled=", sleep_time_enabled, "&start_sleep_time=", start_sleep_time, "&end_sleep_time=", end_sleep_time, "&time_zone=", time_zone, "&lang=", lang);
		}
		...
		public virtual IAsyncResult UpdateProfile(UpdateProfileOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "account/update_profile", FormatAsString, "?name=", name, "&url=", url, "&location=", location, "&description=", description, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult UpdateProfileBackgroundImage(UpdateProfileBackgroundImageOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "account/update_profile_background_image", FormatAsString, "?image_path=", imagePath, "&tile=", tile, "&include_entities=", include_entities, "&skip_status=", skip_status, "&use=", use);
		}
		...
		public virtual IAsyncResult UpdateProfileColors(UpdateProfileColorsOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "account/update_profile_colors", FormatAsString, "?profile_background_color=", profile_background_color, "&profile_link_color=", profile_link_color, "&profile_sidebar_border_color=", profile_sidebar_border_color, "&profile_sidebar_fill_color=", profile_sidebar_fill_color, "&profile_text_color=", profile_text_color, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult UpdateProfileImage(UpdateProfileImageOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "account/update_profile_image", FormatAsString, "?image_path=", image_path, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult BlockUser(BlockUserOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "blocks/create", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult UnblockUser(UnblockUserOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "blocks/destroy", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult UnfavoriteTweet(UnfavoriteTweetOptions options, Action<TwitterStatus, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "favorites/destroy", FormatAsString, "?id=", id);
		}
		...
		public virtual IAsyncResult FavoriteTweet(FavoriteTweetOptions options, Action<TwitterStatus, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "favorites/create", FormatAsString, "?id=", id, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult RemoveListMember(RemoveListMemberOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "lists/members/destroy", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&user_id=", user_id, "&screen_name=", screen_name, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual IAsyncResult FollowList(FollowListOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "lists/subscribers/create", FormatAsString, "?owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&list_id=", list_id, "&slug=", slug);
		}
		...
		public virtual IAsyncResult UnfollowList(UnfollowListOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "lists/subscribers/destroy", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual IAsyncResult AddListMember(AddListMemberOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "lists/members/create", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&user_id=", user_id, "&screen_name=", screen_name, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual IAsyncResult DeleteList(DeleteListOptions options, Action<TwitterList, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "lists/destroy", FormatAsString, "?owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&list_id=", list_id, "&slug=", slug);
		}
		...
		public virtual IAsyncResult CreateList(CreateListOptions options, Action<TwitterList, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "lists/create", FormatAsString, "?list_owner=", list_owner, "&name=", name, "&mode=", mode, "&description=", description);
		}
		...
		public virtual IAsyncResult CreateSavedSearch(CreateSavedSearchOptions options, Action<TwitterSavedSearch, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "saved_searches/create", FormatAsString, "?query=", query);
		}
		...
		public virtual IAsyncResult DeleteSavedSearch(DeleteSavedSearchOptions options, Action<TwitterSavedSearch, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "saved_searches/destroy/{id}", FormatAsString, "?id=", id);
		}
		...
		public virtual IAsyncResult ReportSpam(ReportSpamOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			return WithHammock(HttpMethod.Post, action, "users/report_spam", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id);
		}
		...
		public virtual IAsyncResult BeginListTweetsMentioningMe(ListTweetsMentioningMeOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterStatus>>(HttpMethod.Get, "statuses/mentions_timeline", FormatAsString, "?count=", count, "&since_id=", since_id, "&max_id=", max_id, "&trim_user=", trim_user, "&contributor_details=", contributor_details, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult BeginListTweetsOnUserTimeline(ListTweetsOnUserTimelineOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterStatus>>(HttpMethod.Get, "statuses/user_timeline", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&since_id=", since_id, "&count=", count, "&max_id=", max_id, "&trim_user=", trim_user, "&exclude_replies=", exclude_replies, "&contributor_details=", contributor_details, "&include_rts=", include_rts);
		}
		...
		public virtual IAsyncResult BeginListTweetsOnHomeTimeline(ListTweetsOnHomeTimelineOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterStatus>>(HttpMethod.Get, "statuses/home_timeline", FormatAsString, "?count=", count, "&since_id=", since_id, "&max_id=", max_id, "&trim_user=", trim_user, "&exclude_replies=", exclude_replies, "&contributor_details=", contributor_details, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult BeginListRetweetsOfMyTweets(ListRetweetsOfMyTweetsOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterStatus>>(HttpMethod.Get, "statuses/retweets_of_me", FormatAsString, "?count=", count, "&since_id=", since_id, "&max_id=", max_id, "&trim_user=", trim_user, "&include_entities=", include_entities, "&include_user_entities=", include_user_entities);
		}
		...
		public virtual IAsyncResult BeginRetweets(RetweetsOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterStatus>>(HttpMethod.Get, "statuses/retweets/{id}", FormatAsString, "?id=", id, "&count=", count, "&trim_user=", trim_user);
		}
		...
		public virtual IAsyncResult BeginGetTweet(GetTweetOptions options)
		{
			...
			return BeginWithHammock<TwitterStatus>(HttpMethod.Get, "statuses/show/{id}", FormatAsString, "?id=", id, "&trim_user=", trim_user, "&include_my_retweet=", include_my_retweet, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult BeginDeleteTweet(DeleteTweetOptions options)
		{
			...
			return BeginWithHammock<TwitterStatus>(HttpMethod.Delete, "statuses/destroy/{id}", FormatAsString, "?id=", id, "&trim_user=", trim_user);
		}
		...
		public virtual IAsyncResult BeginSendTweet(SendTweetOptions options)
		{
			...
			return BeginWithHammock<TwitterStatus>(HttpMethod.Post, "statuses/update", FormatAsString, "?status=", status, "&in_reply_to_status_id=", in_reply_to_status_id, "&lat=", lat, "&long=", @long, "&place_id=", place_id, "&display_coordinates=", display_coordinates, "&trim_user=", trim_user);
		}
		...
		public virtual IAsyncResult BeginRetweet(RetweetOptions options)
		{
			...
			return BeginWithHammock<TwitterStatus>(HttpMethod.Post, "statuses/retweet/{id}", FormatAsString, "?id=", id, "&trim_user=", trim_user);
		}
		...
		public virtual IAsyncResult BeginSendTweetWithMedia(SendTweetWithMediaOptions options)
		{
			...
			return BeginWithHammock<TwitterStatus>(HttpMethod.Post, "statuses/update_with_media", images, FormatAsString, "?status=", status, "&possibly_sensitive=", possibly_sensitive, "&in_reply_to_status_id=", in_reply_to_status_id, "&lat=", lat, "&long=", @long, "&place_id=", place_id, "&display_coordinates=", display_coordinates);
		}
		...
		public virtual IAsyncResult BeginSearch(SearchOptions options)
		{
			...
			return BeginWithHammock<TwitterSearchResult>(HttpMethod.Get, "search/tweets", FormatAsString, "?q=", q, "&geocode=", geocode, "&lang=", lang, "&locale=", locale, "&result_type=", resultType, "&count=", count, "&since_id=", since_id, "&max_id=", max_id, "&include_entities=", include_entities, "&callback=", callback);
		}
		...
		public virtual IAsyncResult BeginListDirectMessagesReceived(ListDirectMessagesReceivedOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterDirectMessage>>(HttpMethod.Get, "direct_messages", FormatAsString, "?since_id=", since_id, "&max_id=", max_id, "&count=", count, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult BeginListDirectMessagesSent(ListDirectMessagesSentOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterDirectMessage>>(HttpMethod.Get, "direct_messages/sent", FormatAsString, "?since_id=", since_id, "&max_id=", max_id, "&count=", count, "&page=", page, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult BeginGetDirectMessage(GetDirectMessageOptions options)
		{
			...
			return BeginWithHammock<TwitterDirectMessage>(HttpMethod.Get, "direct_messages/show", FormatAsString, "?id=", id);
		}
		...
		public virtual IAsyncResult BeginDeleteDirectMessage(DeleteDirectMessageOptions options)
		{
			...
			return BeginWithHammock<TwitterDirectMessage>(HttpMethod.Post, "direct_messages/destroy", FormatAsString, "?id=", id, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult BeginSendDirectMessage(SendDirectMessageOptions options)
		{
			...
			return BeginWithHammock<TwitterDirectMessage>(HttpMethod.Post, "direct_messages/new", FormatAsString, "?text=", text, "&user_id=", user_id, "&screen_name=", screen_name);
		}
		...
		public virtual IAsyncResult BeginListFriendIdsOf(ListFriendIdsOfOptions options)
		{
			...
			return BeginWithHammock<TwitterCursorList<long>>(HttpMethod.Get, "friends/ids", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&cursor=", cursor, "&count=", count);
		}
		...
		public virtual IAsyncResult BeginListFollowerIdsOf(ListFollowerIdsOfOptions options)
		{
			...
			return BeginWithHammock<TwitterCursorList<long>>(HttpMethod.Get, "followers/ids", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&cursor=", cursor, "&count=", count);
		}
		...
		public virtual IAsyncResult BeginListFriendshipsFor(ListFriendshipsForOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterFriendshipLookup>>(HttpMethod.Get, "friendships/lookup", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id);
		}
		...
		public virtual IAsyncResult BeginGetIncomingFriendRequests(GetIncomingFriendRequestsOptions options)
		{
			...
			return BeginWithHammock<TwitterCursorList<long>>(HttpMethod.Get, "friendships/incoming", FormatAsString, "?cursor=", cursor);
		}
		...
		public virtual IAsyncResult BeginGetOutgoingFriendRequests(GetOutgoingFriendRequestsOptions options)
		{
			...
			return BeginWithHammock<TwitterCursorList<long>>(HttpMethod.Get, "friendships/outgoing", FormatAsString, "?cursor=", cursor);
		}
		...
		public virtual IAsyncResult BeginFollowUser(FollowUserOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "friendships/create", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&follow=", follow);
		}
		...
		public virtual IAsyncResult BeginUnfollowUser(UnfollowUserOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "friendships/destroy", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id);
		}
		...
		public virtual IAsyncResult BeginUpdateFriendship(UpdateFriendshipOptions options)
		{
			...
			return BeginWithHammock<TwitterFriendship>(HttpMethod.Post, "friendships/update", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&device=", device, "&retweets=", retweets);
		}
		...
		public virtual IAsyncResult BeginGetFriendshipInfo(GetFriendshipInfoOptions options)
		{
			...
			return BeginWithHammock<TwitterFriendship>(HttpMethod.Get, "friendships/show", FormatAsString, "?source_id=", source_id, "&source_screen_name=", source_screen_name, "&target_id=", target_id, "&target_screen_name=", target_screen_name);
		}
		...
		public virtual IAsyncResult BeginListFriends(ListFriendsOptions options)
		{
			...
			return BeginWithHammock<TwitterCursorList<TwitterUser>>(HttpMethod.Get, "friends/list", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&cursor=", cursor, "&skip_status=", skip_status, "&include_user_entities=", include_user_entities);
		}
		...
		public virtual IAsyncResult BeginListFollowers(ListFollowersOptions options)
		{
			...
			return BeginWithHammock<TwitterCursorList<TwitterUser>>(HttpMethod.Get, "followers/list", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&cursor=", cursor, "&skip_status=", skip_status, "&include_user_entities=", include_user_entities);
		}
		...
		public virtual IAsyncResult BeginGetAccountSettings()
		{
			...
			return BeginWithHammock<TwitterAccount>(HttpMethod.Get, "account/settings", FormatAsString);
		}
		...
		public virtual IAsyncResult BeginGetUserProfile(GetUserProfileOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Get, "account/verify_credentials", FormatAsString, "?include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult BeginUpdateAccountSettings(UpdateAccountSettingsOptions options)
		{
			...
			return BeginWithHammock<TwitterAccount>(HttpMethod.Post, "account/settings", FormatAsString, "?trend_location_woeid=", trend_location_woeid, "&sleep_time_enabled=", sleep_time_enabled, "&start_sleep_time=", start_sleep_time, "&end_sleep_time=", end_sleep_time, "&time_zone=", time_zone, "&lang=", lang);
		}
		...
		public virtual IAsyncResult BeginUpdateDeliveryDevice(UpdateDeliveryDeviceOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Get, "account/update_delivery_device", FormatAsString, "?device=", device, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult BeginUpdateProfile(UpdateProfileOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "account/update_profile", FormatAsString, "?name=", name, "&url=", url, "&location=", location, "&description=", description, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult BeginUpdateProfileBackgroundImage(UpdateProfileBackgroundImageOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "account/update_profile_background_image", FormatAsString, "?image_path=", imagePath, "&tile=", tile, "&include_entities=", include_entities, "&skip_status=", skip_status, "&use=", use);
		}
		...
		public virtual IAsyncResult BeginUpdateProfileColors(UpdateProfileColorsOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "account/update_profile_colors", FormatAsString, "?profile_background_color=", profile_background_color, "&profile_link_color=", profile_link_color, "&profile_sidebar_border_color=", profile_sidebar_border_color, "&profile_sidebar_fill_color=", profile_sidebar_fill_color, "&profile_text_color=", profile_text_color, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult BeginUpdateProfileImage(UpdateProfileImageOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "account/update_profile_image", FormatAsString, "?image_path=", image_path, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult BeginListBlockedUsers(ListBlockedUsersOptions options)
		{
			...
			return BeginWithHammock<TwitterCursorList<TwitterUser>>(HttpMethod.Get, "blocks/list", FormatAsString, "?include_entities=", include_entities, "&skip_status=", skip_status, "&cursor=", cursor);
		}
		...
		public virtual IAsyncResult BeginListBlockedUserIds(ListBlockedUserIdsOptions options)
		{
			...
			return BeginWithHammock<TwitterCursorList<long>>(HttpMethod.Get, "blocks/ids", FormatAsString, "?cursor=", cursor);
		}
		...
		public virtual IAsyncResult BeginBlockUser(BlockUserOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "blocks/create", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult BeginUnblockUser(UnblockUserOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "blocks/destroy", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult BeginListUserProfilesFor(ListUserProfilesForOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterUser>>(HttpMethod.Get, "users/lookup", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult BeginGetUserProfileFor(GetUserProfileForOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Get, "users/show", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult BeginSearchForUser(SearchForUserOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterUser>>(HttpMethod.Get, "users/search", FormatAsString, "?q=", q, "&page=", page, "&count=", count, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult BeginListSuggestedUsers(ListSuggestedUsersOptions options)
		{
			...
			return BeginWithHammock<TwitterUserSuggestions>(HttpMethod.Get, "/users/suggestions/{slug}", FormatAsString, "?slug=", slug, "&lang=", lang);
		}
		...
		public virtual IAsyncResult BeginListSuggestedUserCategories(ListSuggestedUserCategoriesOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterUserSuggestions>>(HttpMethod.Get, "users/suggestions", FormatAsString, "?lang=", lang);
		}
		...
		public virtual IAsyncResult BeginGetSuggestedUserMembers(GetSuggestedUserMembersOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterUser>>(HttpMethod.Get, "/users/suggestions/{slug}/members", FormatAsString, "?slug=", slug);
		}
		...
		public virtual IAsyncResult BeginListFavoriteTweets(ListFavoriteTweetsOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterStatus>>(HttpMethod.Get, "favorites/list", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&count=", count, "&since_id=", since_id, "&max_id=", max_id, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult BeginUnfavoriteTweet(UnfavoriteTweetOptions options)
		{
			...
			return BeginWithHammock<TwitterStatus>(HttpMethod.Post, "favorites/destroy", FormatAsString, "?id=", id);
		}
		...
		public virtual IAsyncResult BeginFavoriteTweet(FavoriteTweetOptions options)
		{
			...
			return BeginWithHammock<TwitterStatus>(HttpMethod.Post, "favorites/create", FormatAsString, "?id=", id, "&include_entities=", include_entities);
		}
		...
		public virtual IAsyncResult BeginListListsFor(ListListsForOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterList>>(HttpMethod.Get, "lists/list", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name);
		}
		...
		public virtual IAsyncResult BeginListTweetsOnList(ListTweetsOnListOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterStatus>>(HttpMethod.Get, "lists/statuses", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&since_id=", since_id, "&max_id=", max_id, "&count=", count, "&include_entities=", include_entities, "&include_rts=", include_rts);
		}
		...
		public virtual IAsyncResult BeginRemoveListMember(RemoveListMemberOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "lists/members/destroy", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&user_id=", user_id, "&screen_name=", screen_name, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual IAsyncResult BeginListListMembershipsFor(ListListMembershipsForOptions options)
		{
			...
			return BeginWithHammock<TwitterCursorList<TwitterList>>(HttpMethod.Get, "lists/memberships", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&cursor=", cursor, "&filter_to_owned_lists=", filter_to_owned_lists);
		}
		...
		public virtual IAsyncResult BeginListListSubscribers(ListListSubscribersOptions options)
		{
			...
			return BeginWithHammock<TwitterCursorList<TwitterUser>>(HttpMethod.Get, "lists/subscribers", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&cursor=", cursor, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult BeginFollowList(FollowListOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "lists/subscribers/create", FormatAsString, "?owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&list_id=", list_id, "&slug=", slug);
		}
		...
		public virtual IAsyncResult BeginVerifyListSubscription(VerifyListSubscriptionOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Get, "lists/subscribers/show", FormatAsString, "?owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&list_id=", list_id, "&slug=", slug, "&user_id=", user_id, "&screen_name=", screen_name, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult BeginUnfollowList(UnfollowListOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "lists/subscribers/destroy", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual IAsyncResult BeginVerifyListMembership(VerifyListMembershipOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Get, "lists/members/show", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&user_id=", user_id, "&screen_name=", screen_name, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult BeginListListMembers(ListListMembersOptions options)
		{
			...
			return BeginWithHammock<TwitterCursorList<TwitterUser>>(HttpMethod.Get, "lists/members", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&cursor=", cursor, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual IAsyncResult BeginAddListMember(AddListMemberOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "lists/members/create", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&user_id=", user_id, "&screen_name=", screen_name, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual IAsyncResult BeginDeleteList(DeleteListOptions options)
		{
			...
			return BeginWithHammock<TwitterList>(HttpMethod.Post, "lists/destroy", FormatAsString, "?owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&list_id=", list_id, "&slug=", slug);
		}
		...
		public virtual IAsyncResult BeginCreateList(CreateListOptions options)
		{
			...
			return BeginWithHammock<TwitterList>(HttpMethod.Post, "lists/create", FormatAsString, "?list_owner=", list_owner, "&name=", name, "&mode=", mode, "&description=", description);
		}
		...
		public virtual IAsyncResult BeginGetList(GetListOptions options)
		{
			...
			return BeginWithHammock<TwitterList>(HttpMethod.Get, "lists/show", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual IAsyncResult BeginListSubscriptions(ListSubscriptionsOptions options)
		{
			...
			return BeginWithHammock<TwitterCursorList<TwitterList>>(HttpMethod.Get, "lists/subscriptions", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&count=", count, "&cursor=", cursor);
		}
		...
		public virtual IAsyncResult BeginListSavedSearches()
		{
			...
			return BeginWithHammock<IEnumerable<TwitterSavedSearch>>(HttpMethod.Get, "saved_searches/list", FormatAsString);
		}
		...
		public virtual IAsyncResult BeginGetSavedSearch(GetSavedSearchOptions options)
		{
			...
			return BeginWithHammock<TwitterSavedSearch>(HttpMethod.Get, "saved_searches/show/{id}", FormatAsString, "?id=", id);
		}
		...
		public virtual IAsyncResult BeginCreateSavedSearch(CreateSavedSearchOptions options)
		{
			...
			return BeginWithHammock<TwitterSavedSearch>(HttpMethod.Post, "saved_searches/create", FormatAsString, "?query=", query);
		}
		...
		public virtual IAsyncResult BeginDeleteSavedSearch(DeleteSavedSearchOptions options)
		{
			...
			return BeginWithHammock<TwitterSavedSearch>(HttpMethod.Post, "saved_searches/destroy/{id}", FormatAsString, "?id=", id);
		}
		...
		public virtual IAsyncResult BeginGetPlace(GetPlaceOptions options)
		{
			...
			return BeginWithHammock<TwitterPlace>(HttpMethod.Get, "geo/id/{place_id}", FormatAsString, "?place_id=", place_id);
		}
		...
		public virtual IAsyncResult BeginReverseGeocode(ReverseGeocodeOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterPlace>>(HttpMethod.Get, "geo/reverse_geocode", FormatAsString, "?lat=", lat, "&long=", @long, "&accuracy=", accuracy, "&granularity=", granularity, "&max_results=", max_results, "&callback=", callback);
		}
		...
		public virtual IAsyncResult BeginGeoSearch(GeoSearchOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<TwitterPlace>>(HttpMethod.Get, "geo/search", FormatAsString, "?lat=", lat, "&long=", @long, "&query=", query, "&ip=", ip, "&granularity=", granularity, "&accuracy=", accuracy, "&max_results=", max_results, "&contained_within=", contained_within, "&callback=", callback);
		}
		...
		public virtual IAsyncResult BeginListLocalTrendsFor(ListLocalTrendsForOptions options)
		{
			...
			return BeginWithHammock<TwitterTrends>(HttpMethod.Get, "trends/place", FormatAsString, "?id=", id, "&exclude=", exclude);
		}
		...
		public virtual IAsyncResult BeginListAvailableTrendsLocations()
		{
			...
			return BeginWithHammock<IEnumerable<WhereOnEarthLocation>>(HttpMethod.Get, "trends/available", FormatAsString);
		}
		...
		public virtual IAsyncResult BeginListClosestTrendsLocations(ListClosestTrendsLocationsOptions options)
		{
			...
			return BeginWithHammock<IEnumerable<WhereOnEarthLocation>>(HttpMethod.Get, "trends/closest", FormatAsString, "?lat=", lat, "&long=", @long);
		}
		...
		public virtual IAsyncResult BeginGetRateLimitStatus(GetRateLimitStatusOptions options)
		{
			...
			return BeginWithHammock<TwitterRateLimitStatusSummary>(HttpMethod.Get, "application/rate_limit_status", FormatAsString, "?resources=", resources);
		}
		...
		public virtual IAsyncResult BeginReportSpam(ReportSpamOptions options)
		{
			...
			return BeginWithHammock<TwitterUser>(HttpMethod.Post, "users/report_spam", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id);
		}
		...
		public virtual void DeleteTweet(DeleteTweetOptions options, Action<TwitterStatus, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Delete, action, "statuses/destroy/{id}", FormatAsString, "?id=", id, "&trim_user=", trim_user);
		}
		...
		public virtual void SendTweet(SendTweetOptions options, Action<TwitterStatus, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "statuses/update", FormatAsString, "?status=", status, "&in_reply_to_status_id=", in_reply_to_status_id, "&lat=", lat, "&long=", @long, "&place_id=", place_id, "&display_coordinates=", display_coordinates, "&trim_user=", trim_user);
		}
		...
		public virtual void Retweet(RetweetOptions options, Action<TwitterStatus, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "statuses/retweet/{id}", FormatAsString, "?id=", id, "&trim_user=", trim_user);
		}
		...
		public virtual void SendTweetWithMedia(SendTweetWithMediaOptions options, Action<TwitterStatus, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "statuses/update_with_media", FormatAsString, "?status=", status, "&possibly_sensitive=", possibly_sensitive, "&in_reply_to_status_id=", in_reply_to_status_id, "&lat=", lat, "&long=", @long, "&place_id=", place_id, "&display_coordinates=", display_coordinates);
		}
		...
		public virtual void DeleteDirectMessage(DeleteDirectMessageOptions options, Action<TwitterDirectMessage, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "direct_messages/destroy", FormatAsString, "?id=", id, "&include_entities=", include_entities);
		}
		...
		public virtual void SendDirectMessage(SendDirectMessageOptions options, Action<TwitterDirectMessage, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "direct_messages/new", FormatAsString, "?text=", text, "&user_id=", user_id, "&screen_name=", screen_name);
		}
		...
		public virtual void FollowUser(FollowUserOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "friendships/create", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&follow=", follow);
		}
		...
		public virtual void UnfollowUser(UnfollowUserOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "friendships/destroy", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id);
		}
		...
		public virtual void UpdateFriendship(UpdateFriendshipOptions options, Action<TwitterFriendship, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "friendships/update", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&device=", device, "&retweets=", retweets);
		}
		...
		public virtual void UpdateAccountSettings(UpdateAccountSettingsOptions options, Action<TwitterAccount, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "account/settings", FormatAsString, "?trend_location_woeid=", trend_location_woeid, "&sleep_time_enabled=", sleep_time_enabled, "&start_sleep_time=", start_sleep_time, "&end_sleep_time=", end_sleep_time, "&time_zone=", time_zone, "&lang=", lang);
		}
		...
		public virtual void UpdateProfile(UpdateProfileOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "account/update_profile", FormatAsString, "?name=", name, "&url=", url, "&location=", location, "&description=", description, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual void UpdateProfileBackgroundImage(UpdateProfileBackgroundImageOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "account/update_profile_background_image", FormatAsString, "?image_path=", imagePath, "&tile=", tile, "&include_entities=", include_entities, "&skip_status=", skip_status, "&use=", use);
		}
		...
		public virtual void UpdateProfileColors(UpdateProfileColorsOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "account/update_profile_colors", FormatAsString, "?profile_background_color=", profile_background_color, "&profile_link_color=", profile_link_color, "&profile_sidebar_border_color=", profile_sidebar_border_color, "&profile_sidebar_fill_color=", profile_sidebar_fill_color, "&profile_text_color=", profile_text_color, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual void UpdateProfileImage(UpdateProfileImageOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "account/update_profile_image", FormatAsString, "?image_path=", image_path, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual void BlockUser(BlockUserOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "blocks/create", FormatAsString, "?user_id=", user_id, "&screen_name=", screen_name, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual void UnblockUser(UnblockUserOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "blocks/destroy", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id, "&include_entities=", include_entities, "&skip_status=", skip_status);
		}
		...
		public virtual void UnfavoriteTweet(UnfavoriteTweetOptions options, Action<TwitterStatus, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "favorites/destroy", FormatAsString, "?id=", id);
		}
		...
		public virtual void FavoriteTweet(FavoriteTweetOptions options, Action<TwitterStatus, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "favorites/create", FormatAsString, "?id=", id, "&include_entities=", include_entities);
		}
		...
		public virtual void RemoveListMember(RemoveListMemberOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "lists/members/destroy", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&user_id=", user_id, "&screen_name=", screen_name, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual void FollowList(FollowListOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "lists/subscribers/create", FormatAsString, "?owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&list_id=", list_id, "&slug=", slug);
		}
		...
		public virtual void UnfollowList(UnfollowListOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "lists/subscribers/destroy", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual void AddListMember(AddListMemberOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "lists/members/create", FormatAsString, "?list_id=", list_id, "&slug=", slug, "&user_id=", user_id, "&screen_name=", screen_name, "&owner_screen_name=", owner_screen_name, "&owner_id=", owner_id);
		}
		...
		public virtual void DeleteList(DeleteListOptions options, Action<TwitterList, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "lists/destroy", FormatAsString, "?owner_screen_name=", owner_screen_name, "&owner_id=", owner_id, "&list_id=", list_id, "&slug=", slug);
		}
		...
		public virtual void CreateList(CreateListOptions options, Action<TwitterList, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "lists/create", FormatAsString, "?list_owner=", list_owner, "&name=", name, "&mode=", mode, "&description=", description);
		}
		...
		public virtual void CreateSavedSearch(CreateSavedSearchOptions options, Action<TwitterSavedSearch, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "saved_searches/create", FormatAsString, "?query=", query);
		}
		...
		public virtual void DeleteSavedSearch(DeleteSavedSearchOptions options, Action<TwitterSavedSearch, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "saved_searches/destroy/{id}", FormatAsString, "?id=", id);
		}
		...
		public virtual void ReportSpam(ReportSpamOptions options, Action<TwitterUser, TwitterResponse> action)
		{
			...
			WithHammock(HttpMethod.Post, action, "users/report_spam", FormatAsString, "?screen_name=", screen_name, "&user_id=", user_id);
		}
